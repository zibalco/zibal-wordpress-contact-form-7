...
function zibal_cf7_transactions_page() {
    ...
    if ( isset( $_GET['action'] ) && $_GET['action'] === 'delete' && isset( $_GET['id'] ) ) {
        check_admin_referer( 'zibal_delete_transaction_' . $_GET['id'] );
                ...
                <?php else : ?>
                    <?php foreach ( $transactions as $transaction ) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=zibal-cf7-transaction&id=' . $transaction->id ) ); ?>">
                                    <?php echo esc_html__( 'مشاهده', 'zibal-cf7' ); ?>
                                </a>
                                |
...
function zibal_cf7_plugin_action_links( $links ) {
    ...
    array_unshift( $links, $settings_link, $transactions_link );
